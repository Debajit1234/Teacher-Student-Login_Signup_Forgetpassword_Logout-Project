...
@WebServlet("/ssignup")
public class StudentSignUpGet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String name = req.getParameter("studentsname");
            req.setAttribute("name", name);
            int password = Integer.parseInt(req.getParameter("studentspassword"));
            ...
            if (password != 123) {
                ...
                RequestDispatcher rd = req.getRequestDispatcher("studentSignUp.html");
                rd.include(req, resp);
            } else {
