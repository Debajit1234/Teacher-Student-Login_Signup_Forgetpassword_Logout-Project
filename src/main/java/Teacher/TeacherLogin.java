...
public class TeacherLogin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            int id = Integer.parseInt(req.getParameter("teacherlid"));
...
//        response.sendRedirect("studentLogin.html");
            ...
            int password = Integer.parseInt(req.getParameter("teacherlpassword"));
            ...
            String HQL = "FROM TeacherLogDetails WHERE id=:Id AND password=:pass";
            Query<TeacherLogDetails> query = s.createQuery(HQL, TeacherLogDetails.class);
            query.setParameter("pass", password);
            query.setParameter("Id", id);

            TeacherLogDetails teacher = query.uniqueResult();
