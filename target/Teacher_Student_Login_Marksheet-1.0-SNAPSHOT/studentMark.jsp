...
<header>
    <div class="tr">
        <tr>
            <td class="td"><a href="slogout">Logout</a></td>
        </tr>
    </div>
</header>
...
//-------------------------------------------------------
        ...
        String HQL="FROM StudentLogDetail where id=:sid";
        ...
        for(int i=0;i<list.size();i++){
            ...
            if(list.get(i).getMark().getC()==-1 || list.get(i).getMark().getJava()==-1){
                request.setAttribute("name",list.get(i).getName());
                RequestDispatcher rd = request.getRequestDispatcher("studentWelcomePage.jsp");
